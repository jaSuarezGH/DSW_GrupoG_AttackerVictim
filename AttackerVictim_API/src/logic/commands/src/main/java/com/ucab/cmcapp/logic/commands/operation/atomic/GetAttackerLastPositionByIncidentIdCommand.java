...
public class GetAttackerLastPositionByIncidentIdCommand extends Command<Incident> {

    private Incident _incident;
    private IncidentDao _dao;
    private History _result;

    public GetAttackerLastPositionByIncidentIdCommand(Incident incident) {
        _incident = incident;
    ...
    @Override
    public void execute() {
        _result = _dao.getAttackerLastPositionByIncidentId(_incident);
    }
