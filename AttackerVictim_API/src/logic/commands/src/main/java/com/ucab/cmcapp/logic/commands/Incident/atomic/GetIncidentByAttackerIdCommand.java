...
public class GetIncidentByAttackerIdCommand extends Command<Incident> {

    private Incident _incident;
    private IncidentDao _dao;

    public GetIncidentByAttackerIdCommand(Incident incident) {
        _incident = incident;
    ...
    @Override
    public void execute() {
        _incident = _dao.getIncidentByAttackerId(_incident.get_attacker());
    }
