...
public class GetAdministratorByUsernameCommand extends Command<Administrator> {

    private Administrator _administrator;
    private AdministratorDao _dao;

    public GetAdministratorByUsernameCommand(Administrator administrator) {
    ...
    @Override
    public void execute() {
        _administrator = _dao.getAdministratorByUsername(_administrator.get_username());
    }
