...
export function GetAllAtacantes({ users }) {

  return (
    <div className="bg-white py-2 sm:py-10 ">
      <div className="mx-auto grid max-w-7xl gap-x-8 gap-y-12 px-6 lg:px-8 ">
        <div className="block max-w-full">
          <span className="inline-flex items-center rounded-md bg-red-50 px-2 py-1 mb-2 ml-2 mr-2 font-medium text-red-700 ring-1 ring-inset ring-red-600/10">
            Atacante
          </span>
          <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
            Usuarios Atacantes en el Sistema
          </h2>
          <p className="mt-6 text-lg leading-8 text-gray-600 block mb-2">
            Usuarios de tipo Atacante registrados en el sistema.
          </p>
        </div>
