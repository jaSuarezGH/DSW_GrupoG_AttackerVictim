...
export default function deleteMACPage({ params }) {
  ...
  if (user === null && control) {
    const description = `Lo siento, el usuario a eliminar poseedor de la Direccion MAC: "${params.mac}" no se encuentra registrado.`;
    return (
      <InformacionPage
