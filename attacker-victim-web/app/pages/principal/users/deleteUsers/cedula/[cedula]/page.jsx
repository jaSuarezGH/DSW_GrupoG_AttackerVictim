...
export default function deleteCedulaPage({ params }) {
  ...
  if (user === null && control) {
    const description = `Lo siento, el usuario a eliminar poseedor de la Cedula de Identidad: "${params.cedula}" no se encuentra registrado.`;
    return (
      <InformacionPage
      ...
      <form className="m-10 mb-2" onSubmit={onSubmit}>
        {show && (
          <DivResponseUser
            ...
            description={`Todos los datos del usuario a consultar poseedor de la Cedula de Identidad: ${params.cedula}.`}
            tags={[]}
          ></DivResponseUser>
        )}
