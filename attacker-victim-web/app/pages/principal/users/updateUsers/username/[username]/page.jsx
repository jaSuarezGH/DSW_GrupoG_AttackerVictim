...
export default function UpdateUsernamePage({ params }) {
  ...
  useEffect(() => {
    const fetchDataUser = async () => {
      ...
      const userFetch = await fetchGetDelete(endGetUserByUsername, params.username);
      setUser(userFetch);
  ...
  if (user === null && control) {
    const description = `Lo siento, el usuario a modificar poseedor del Nombre de Usuario (Username): "${params.username}" no se encuentra registrado.`;
    return (
      <InformacionPage
